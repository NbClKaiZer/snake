...
export function spawnWall(usedTiles) {
    ...
    if (wallDirection == 0) {
        ...
        drawItem(gameCanvas, wallX, wallY, "bricks");
        drawItem(gameCanvas, wallX, wallY+20, "bricks");
        drawItem(gameCanvas, wallX, wallY+40, "bricks");
        ...
        drawItem(gameCanvas, wallX, wallY, "bricks");
        drawItem(gameCanvas, wallX+20, wallY, "bricks");
        drawItem(gameCanvas, wallX+40, wallY, "bricks");
